...
file template would help. Use `browser-cli case scaffold --template page-inspection`, `browser-cli case scaffold --template interactive-targeting`, or `browser-cli case scaffold --template page-diagnostics`
