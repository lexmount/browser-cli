...
- Setup and readiness: version JSON, command discovery, packaged references,
  packaged setup-verification, page-inspection, agent-primitives, content-extraction, browser-state, page-diagnostics, form-fill, and interactive-targeting examples,
...
7. Case files do not yet cover enough real agent tasks. Add examples for login
   reuse, multi-step checkout/forms, file upload, and navigation with assertions
