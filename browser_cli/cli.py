...
def _add_action_commands(subparsers: argparse._SubParsersAction[Any]) -> None:
    ...
    action_guide.add_argument(
        "--task",
        help="Action task guide to inspect, such as form_interaction, file_upload, dialog_frame_handling, interactive_targeting, content_extraction, browser_state_management, state_waits, or page_diagnostics.",
    )
    action_guide.add_argument(
        "--names-only",
        action="store_true",
